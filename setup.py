...
DESCRIPTION = metadata.get('description', 'Premiere League game estimator on odds.')
AUTHOR = metadata.get('author', 'theResquator')
AUTHOR_EMAIL = metadata.get('author_email', 'resquatordaryl@gmail.com')
