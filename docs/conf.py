...
# -*- coding: utf-8 -*-
#
# PL_estimator documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'resquator.PL_estimatordoc'
...
texinfo_documents = [
    ('index', 'resquator.PL_estimator', u'PL_estimator Documentation',
     u"theResquator", 'PL_estimator',
     'Premiere League game estimator on odds.', 'Miscellaneous'),
]
